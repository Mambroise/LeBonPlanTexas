...
"""
Django settings for lebonplantexas project.
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ambroise.lebonplantexas@gmail.com'
# EMAIL_HOST_USER = config('EMAIL_HOST_USER')
# EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')
EMAIL_HOST_PASSWORD = 'nsjf zkiu zlkn stql'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lebonplantexas',
        'USER': 'morice',
        'PASSWORD': 'maurilebonplantexas2312!',
...
MODELTRANSLATION_LANGUAGES = ('fr', 'en', 'es')
